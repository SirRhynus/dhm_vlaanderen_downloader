...
from .dhm_vlaanderen_downloader_algorithm import DHMVlaanderenDownloaderAlgorithm


class DHMVlaanderenDownloaderProvider(QgsProcessingProvider):
    ...
    def id(self):
        ...
        """
        return 'DHMVlaanderenDownloader'
    ...
    def name(self):
        ...
        """
        return self.tr('DHM Vlaanderen Downloader')
